...
public class Maison extends Batiment {
    ...
    public Maison(String nom, int coutBois, int coutpierre, int coutOr, int capaciteMax, int capacitePopulation) {
        super("hutte", 20, 10, 0, 1);
        this.capacitePopulation = capacitePopulation;
        this.capacitePopulation = 1;
